...
import { ChapterContent, chapterContentListing } from './chapter-content/models/chapterContent';
...
export class AppComponent implements OnInit {
  ...
  this.chaptList$ = this.chapterStore.pipe(select(fromMenu.getChapterListing));
