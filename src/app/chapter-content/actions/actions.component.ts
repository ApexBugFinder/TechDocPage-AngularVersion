...
import {ChapterContent, chapterContentListing, defaultChapterContent} from '../models/chapterContent';
export const actionsChapterInfo: ChapterContent =  { index: 9, name: 'actions', heading: 'Actions', address: 'chapterContent/actions'};
